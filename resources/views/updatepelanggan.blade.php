...
<div>
  ...
  <input class="form-control" id="exampleFormControlTextarea1" rows="3" name="namapelanggan" value="{{$pelanggan->namapelanggan}}"></input>
  </div>
  <div>
  ...
  <input class="form-control" id="exampleFormControlTextarea1" rows="3" name="nomortelepon" value="{{$pelanggan->nomortelepon}}"></input>
  </div>
